                ...
                <div class="flex items-center justify-between p-6">
                    <div class="flex items-center justify-between w-full">
                        ...
                        <div class="ml-4 text-right">
                            ...
                            <p class="text-3xl text-gray-500 dark:text-gray-300">{{ $countTasksToday['pending'] }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex items-center justify-between p-6">
                    <div class="flex items-center justify-between w-full">
                        ...
                        <div class="ml-4 text-right">
                            ...
                            <p class="text-3xl text-gray-500 dark:text-gray-300">{{ $countTasksToday['completed'] }}</p>
                        </div>
                    </div>
                </div>
                <div class="bg-gray-700 rounded-b-lg p-3">
